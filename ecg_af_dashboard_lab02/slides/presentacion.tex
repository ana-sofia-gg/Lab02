...
% Diapositiva 1 (portada + contenido): problema, usuario, pregunta y límite
\begin{frame}{Laboratorio 2 --- Análisis de ECG y Fibrilación Auricular}
    \scriptsize
    \textbf{Integrantes:} Cristian Stiven Capera C., Ana Sofía García G.,
    Jeimmy Andrea Gonzáles G., Karol Mariana Gutiérrez G. y Brayan Andrés Ruiz C.
    \hfill \today
    \vspace{0.15cm}
    \normalsize
...
% Diapositiva 2: ECG, AFDB y cadena de procesamiento
...
% Diapositiva 3: QRS, RR, anotaciones, calidad y pruebas
...
% Diapositiva 4: Demostración y comparación principal con evidencia visual
\begin{frame}{Demostración y Evidencia Visual (Registro 04043)}
    \begin{columns}[T]
        \column{0.48\textwidth}
        \textbf{Exploración y Limitación en AFDB:}
        \begin{itemize}
            \small
            \item \textbf{Ventanas y Envolventes:} Visualización interactiva de QRS aceptados y manejo de tramos largos en Streamlit.
            \item \textbf{Registro 04043:} Bajo artefactos severos de movimiento, el detector genera marcas falsas sobre oscilaciones aleatorias.
            \item \textbf{Valor del Dashboard:} Permite auditar visualmente las fallas algorítmicas frente a la referencia clínica.
        \end{itemize}
        
        \column{0.48\textwidth}
        \centering
        \textbf{Histograma RR Automático:}
        \vspace{0.1cm}
        \includegraphics[width=0.95\textwidth]{../figures/rr_hist_04043.png}
        \tiny
        \par Distribución de intervalos RR generada por \texttt{reproduce.py}.
    \end{columns}
\end{frame}

% Diapositiva 5: Interpretación, limitaciones y reproducción
